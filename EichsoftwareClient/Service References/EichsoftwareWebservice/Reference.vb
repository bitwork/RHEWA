...
Namespace EichsoftwareWebservice
    ...
    Partial Public Class EichsoftwareWebserviceClient
        ...
        Public Function GetAlleEichprozesseNachUploadMonat(ByVal HEKennung As String, ByVal Lizenzschluessel As String, ByVal WindowsUsername As String, ByVal Domainname As String, ByVal Computername As String, ByVal Uploadjahr As Integer, ByVal Uploadmonat As Integer) As EichsoftwareWebservice.clsEichprozessFuerAuswahlliste() Implements EichsoftwareWebservice.IEichsoftwareWebservice.GetAlleEichprozesseNachUploadMonat
            Return MyBase.Channel.GetAlleEichprozesseNachUploadMonat(HEKennung, Lizenzschluessel, WindowsUsername, Domainname, Computername, Uploadjahr, Uploadmonat)
        End Function
