    ...
    Public Sub ExportEichprozess(ByVal objEichProzess As Eichprozess)
        ...
        If FolderBrowserDialog.ShowDialog() = System.Windows.Forms.DialogResult.OK Then
            ...
            With objWordDoc
                ...
                r.InsertAfter("Sicherung Sicherungsmarke Klein: " & pEichProzess.Eichprotokoll.Sicherung_SicherungsmarkeKlein & vbNewLine)
                r.InsertAfter("Sicherung Sicherungsmarke Klein Anzahl: " & pEichProzess.Eichprotokoll.Sicherung_SicherungsmarkeKleinAnzahl & vbNewLine)
                r.InsertAfter("Sicherung_Sicherungsmarke Groß: " & pEichProzess.Eichprotokoll.Sicherung_SicherungsmarkeGross & vbNewLine)
                r.InsertAfter("Sicherung Sicherungsmarke Groß: " & pEichProzess.Eichprotokoll.Sicherung_SicherungsmarkeGrossAnzahl & vbNewLine)
                r.InsertAfter("Hinweismarke: " & pEichProzess.Eichprotokoll.Sicherung_Hinweismarke & vbNewLine)
                r.InsertAfter("Hinweismarke Anzahl: " & pEichProzess.Eichprotokoll.Sicherung_HinweismarkeAnzahl & vbNewLine)
