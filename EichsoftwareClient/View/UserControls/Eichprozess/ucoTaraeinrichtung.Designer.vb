...
Partial Class ucoTaraeinrichtung
    Inherits ucoContent
    ...
    End Sub
    Friend WithEvents lblTaraAusrichtung As Telerik.WinControls.UI.RadLabel
    Friend WithEvents lblGenauigkeit As Telerik.WinControls.UI.RadLabel
    Friend WithEvents lblRichtigkeitspruefung As Telerik.WinControls.UI.RadLabel
    Friend WithEvents RadCheckBoxTaraErweiterteRichtigkeitspruefung As Telerik.WinControls.UI.RadCheckBox
