...
#Region "Methods"
    ...
    Private Sub FillControls()
        ...
        Select Case objEichprozess.Lookup_Waagenart.Art
            Case Is = "Einbereichswaage"
                Try
                    RadTextBoxPunkt5Faktor.Text = (CDec(objEichprozess.Kompatiblitaetsnachweis.Kompatiblitaet_Waage_Hoechstlast1) + CDec(objEichprozess.Kompatiblitaetsnachweis.Kompatiblitaet_Waage_Einschaltnullstellbereich) +
                                                               CDec(objEichprozess.Kompatiblitaetsnachweis.Kompatiblitaet_Waage_Ecklastzuschlag) + CDec(objEichprozess.Kompatiblitaetsnachweis.Kompatiblitaet_Waage_Totlast) +
            ...
            Case Is = "Zweibereichswaage", "Zweiteilungswaage"
                RadTextBoxPunkt5Faktor.Text = (CDec(objEichprozess.Kompatiblitaetsnachweis.Kompatiblitaet_Waage_Hoechstlast2) + CDec(objEichprozess.Kompatiblitaetsnachweis.Kompatiblitaet_Waage_Einschaltnullstellbereich) +
                                               CDec(objEichprozess.Kompatiblitaetsnachweis.Kompatiblitaet_Waage_Ecklastzuschlag) + CDec(objEichprozess.Kompatiblitaetsnachweis.Kompatiblitaet_Waage_Totlast) +
            ...
            Case Else
                Try
                    ...
                    RadTextBoxPunkt5Faktor.Text = (CDec(objEichprozess.Kompatiblitaetsnachweis.Kompatiblitaet_Waage_Hoechstlast3) + CDec(objEichprozess.Kompatiblitaetsnachweis.Kompatiblitaet_Waage_Einschaltnullstellbereich) +
                                               CDec(objEichprozess.Kompatiblitaetsnachweis.Kompatiblitaet_Waage_Ecklastzuschlag) + CDec(objEichprozess.Kompatiblitaetsnachweis.Kompatiblitaet_Waage_Totlast) +
