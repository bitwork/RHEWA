Public Class ucoKompatiblititaetsnachweis
    Inherits ucoContent
...
#End Region
    ...
    ''' <param name="e"></param>
    ''' <remarks></remarks>
    Private Sub RadTextBoxControlWaageKlasse_MouseHover(sender As Object, e As EventArgs) _
        Handles RadTextBoxControlWaageTotlast.MouseHover,
