Public Class frmZwischenwerte
    ...
    Sub New(ByVal pObjEichprozess As Eichprozess, pStaffel As String, pBereich As String)
        ...
        Me.UcoZwischenwerte = New ucoZwischenwerte(Nothing, pObjEichprozess, pStaffel, pBereich)
