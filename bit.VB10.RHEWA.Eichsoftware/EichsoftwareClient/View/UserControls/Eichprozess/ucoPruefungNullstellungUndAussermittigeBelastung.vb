        ...
        If Not DialogModus = enuDialogModus.lesend And Not DialogModus = enuDialogModus.korrigierend Then
            Using context As New EichsoftwareClientdatabaseEntities1
                ...
                objEichprozess = (From a In context.Eichprozess.Include("Lookup_Auswertegeraet").Include("Kompatiblitaetsnachweis"). _
                                  Include("Lookup_Waegezelle").Include("Lookup_Waagenart").Include("Eichprotokoll") Select a Where a.ID = objEichprozess.ID).FirstOrDefault
    ...
    Private Function ValidateControls() As Boolean
        ...
        If ValidateControlsNullstellung() Then
            If ValidateControlsAussermittigeBelastung() Then
                ...
                End If
            Else
                MessageBox.Show(My.Resources.GlobaleLokalisierung.EichfehlergrenzenNichtEingehalten, "", MessageBoxButtons.OK, MessageBoxIcon.Exclamation)
                AbortSaveing = True
                Return False
            End If
        Else
    ...
    Protected Friend Overrides Sub SaveWithoutValidationNeeded(usercontrol As UserControl)
        ...
        If Me.Equals(usercontrol) Then
            ...
            Using Context As New EichsoftwareClientdatabaseEntities1
                ...
                If objEichprozess.ID <> 0 Then 'an dieser stelle muss eine ID existieren
                    'prüfen ob das Objekt anhand der ID gefunden werden kann
                    Dim dobjEichprozess As Eichprozess = Context.Eichprozess.Include("Lookup_Waagenart").FirstOrDefault(Function(value) value.ID = objEichprozess.ID)
                    If Not dobjEichprozess Is Nothing Then
                        'lokale Variable mit Instanz aus DB überschreiben. Dies ist notwendig, damit das Entity Framework weiß, das ein Update vorgenommen werden muss.
                        objEichprozess = dobjEichprozess
                        'neuen Status zuweisen
